...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.initializeAPI = function () {
        return this.http.get('http://makeup-api.herokuapp.com/api/v1/products.json');
    };
    ApiService.prototype.getByProduct = function (id) {
        return this.http.get("http://makeup-api.herokuapp.com/api/v1/products.json?product_type=" + id);
    };
    ApiService.prototype.getByBrand = function (id) {
        return this.http.get("http://makeup-api.herokuapp.com/api/v1/products.json?brand=" + id);
    };
    ApiService.prototype.getByQuality = function (quality) {
        var filteredArray = [];
        this.apiArray.forEach(function (item) {
            item.tag_list.forEach(function (tag) {
                if (tag === quality) {
