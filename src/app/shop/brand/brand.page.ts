...
export class BrandPage implements OnInit {
  ...
  brands = [
    ...
    {name: 'Coastal Classic Creations', code: 'coastal classic creation', image: '../../../assets/brandImages/coastalClassicCreations.jpg'},
    ...
    {name: 'Sinful Colors', code: 'sinful colours', image: '../../../assets/brandImages/sinfulColors.png'},
